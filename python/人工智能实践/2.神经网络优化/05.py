...
#coding:utf-8
#   设损失函数 loss = (w+1)^2,令w初值是常数0。反向传播就是求最优w，即求最小loss对应的w值
...
#   运行几轮BATCH_SIZE的计数器，初值给0，设为不被训练
...
with tf.Session() as sess:
    ...
    for i in range(40):
        ...
        print("After %s steps: global_step is %f, w is %f, learning rate is %f, loss is %f" % (i, global_step, w_val, learning_rate_val, loss_val))
